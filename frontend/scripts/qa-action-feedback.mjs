...
for (const [source, pattern, label] of [
  ...
  [operationalSource, /setRule\(emptyScheduleRule\(rule\.effective_from \|\| today\)\)/, 'Salvar escala deve limpar colaborador e weekdays'],
  [operationalSource, /setRule\(emptyScheduleRule\(\)\)/, 'Remover escala deve limpar weekdays quando aplicavel'],
